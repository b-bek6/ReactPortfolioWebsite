...
<ol class="relative border-s border-border dark:border-borderDark">                  
    <li class="mb-10 ms-4">
        ...
        <h3 class="text-lg font-semibold text-[#F02EA6] dark:text-[#F02EA6]">The day I said 'hello' to the world!</h3>
    ...
    <li class="mb-10 ms-4">
        ...
        <h3 class="text-lg font-semibold text-[#3DCF8E]">Day I saw a computer</h3>
        <p class="text-base font-normal text-gray-1000 dark:text-subtext">All of the pages and components are first designed in Figma and we keep a parity between the two versions even as we update the project.</p>
    ...
    <li class="ms-4 mb-10">
        ...
        <h3 class="text-lg font-semibold text-gray-900 dark:text-blue-500">Joined <a className='underline italic' href="">Tribhuvan University</a> As Bsc CSIT student </h3>
        <p class="text-base font-normal text-gray-500 dark:text-subtext">i'll discuss about this more.. </p>
    </li>
    <li class="ms-4 mb-10">
        <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
        <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">April 2022</time>
        <h3 class="text-lg font-semibold text-gray-900 dark:text-[#3DCF8E]">Joined <a className='underline italic' href="https://mindrisers.com.np">Mindrisers</a> As a frontend developer </h3>
        <p class="text-base font-normal text-gray-500 dark:text-subtext">i'll discuss about this more.. </p>
    </li>
    <li class="ms-4">
        <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
        <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">April 2023</time>
        <h3 class="text-lg font-semibold text-gray-900 dark:text-red-500">left <a className='underline italic' href="">Mindrisers</a> As a frontend developer </h3>
