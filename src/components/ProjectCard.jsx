...
<a href="#" class="flex flex-col sm:flex-row opacity-75 hover:opacity-100  items-center bg-primary  rounded-lg dark:text-white  md:flex-row p-4  dark:bg-darkPrimary transition-all ease-in-out duration-200">
