...
export default function Card({title, description}) {
  return (
    <div className='text-[18px] text-black dark:text-white flex justify-around items-center gap-8 py-3 mt-5 min-w-[200px] dark:border-[#404040] border-[#b7b6b6]  rounded-md  dark:bg-[#262626] bg-[#dfdfdf]'>
