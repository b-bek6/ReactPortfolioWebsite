        ...
        <div>
            <div className="bg-cover relative bg-center h-[40vh] w-[100vh]" style={{ backgroundImage: `url("data:image/svg+xml,${encodeURIComponent(svgData)}")`, width: '100vw' }}>
                <div className="absolute top-10 left-0 right-0 bottom-0 flex items-center justify-center ">
                    <a href="#" src="#" className="text-white text-lg mx-2 "><svg
                    ...
                    <a href="#" className="text-white  text-lg mx-2  "> <svg
                        // className='delay-700 animate-bounce'
                    ...
                    <a href="#" className="text-white text-lg mx-2 "><svg
                        // className='delay-500 animate-bounce hover:animate-none'
                        viewBox="0 0 960 1000"
                        fill="currentColor"
                        height="2.5em"
                        width="2.5em"
                    ...
                    {/* <a href="#" className="text-white text-lg mx-2 animate-bounce "><svg
                        className='delay-500 animate-bounce hover:animate-none'
                        viewBox="0 0 1024 1024"
                        fill="currentColor"
                        height="1.5em"
