...
function App() {
  ...
  return (
    ...
    <NavigationBar />
      {/* <button onClick={() => { setDark(!dark) }} className={`dark:bg-white  flex justify-center align-middle items-center  z-50 bg-black dark:text-black text-white w-9 h-9 rounded-full fixed left-[70%] top-[7%] transition-all duration-500 ease-in-out overflow-hidden `}>
        <div className='relative'>

        
        <svg
        className={`absolute  ${dark==false?'translate-x-0':'-translate-x-10'} transition-all duration-500 ease-in-out `}
      viewBox="0 0 30 30"
      fill="currentColor"
      height="1.5em"
      width="1.5em"
    ...
    <svg
    className={`absoulte left-10 ${dark==false?'translate-x-10':'translate-x-0'} transition-all duration-500 ease-in-out `}
    viewBox="0 0 30 30"
    fill="currentColor"
    height="1.5em"
    width="1.5em"
  >
    <path d="M15.01 25.71c2.04 0 3.92-.5 5.65-1.51s3.09-2.37 4.09-4.1 1.51-3.61 1.51-5.65-.5-3.92-1.51-5.65-2.37-3.09-4.09-4.09-3.61-1.51-5.65-1.51c1.29 1.39 2.24 3.07 2.84 5.05s.91 4.05.91 6.2c0 .88-.03 1.69-.08 2.44s-.16 1.55-.32 2.41-.38 1.65-.64 2.37-.63 1.43-1.09 2.15-1.01 1.33-1.62 1.89z" />
  </svg>
  </div>
      </button> */}
